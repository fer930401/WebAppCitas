<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NuevasCita.aspx.cs" Inherits="WebAppCitas.NuevasCita" %>
        ...
        <div class="container">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xs-5">
                        <div class="input-group">
                            <asp:Label ID="Label1" runat="server" Text="Fecha de Salida:" CssClass="input-group-addon"></asp:Label>
