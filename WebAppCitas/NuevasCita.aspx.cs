...
{
    public partial class NuevasCita : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    _cmd.CommandText = String.Format("select CONVERT(VARCHAR(10), fec_mov, 21) as fec_Cita from itmov where tipo_doc = 'ltasis' and ef_cve = '001' and num_fol = '{0}'", idCita);
                    _conn.Open();
                    ...
                    txtFecCita.Text = fechaCita;
                        ...
                        _cmd2.CommandText = String.Format("select CONVERT(VARCHAR(10), fec_ultact, 21) as fec_Cita from itmov where tipo_doc = 'ltasis' and ef_cve = '001' and num_fol = '{0}'", idCita);
                        _conn2.Open();
                        fechaCitaFin = Convert.ToString(_cmd2.ExecuteScalar());
                        _cmd2.ExecuteNonQuery();
                        _conn2.Close();
                        txtfecSalida.Text = fechaCitaFin;
        ...
        protected void ButtonOK_Click(object sender, EventArgs e)
        {
            if (Session["RolCve"].ToString().Equals("ATD") == true || Session["RolCve"].ToString().Equals("DIR") == true || Session["RolCve"].ToString().Equals("ADT") == true)
            {
                ...
                DateTime NFechaIni = new DateTime(fechaE.Year, fechaE.Month, fechaE.Day, horaE.Hour, horaE.Minute, horaE.Second),
                       NFechaFin = new DateTime(fechaS.Year, fechaS.Month, fechaS.Day, horaS.Hour, horaS.Minute, horaS.Second);
        ...
        //    ddSala.Items.Insert(4, new ListItem("Otra", "zzzzzz"));
        ...
        {
            DateTime fechaE = Convert.ToDateTime(txtfecSalida.Text);
            DateTime fec_ultact = new DateTime(fechaE.Year, fechaE.Month, fechaE.Day);
            string sala = "zzzzzz",
                    refer = "4",
                    horaE = ddHoraE.Text;
            ...
            else
            {
                ...
                List<Entidades.qcomWebHoraReagenda_Result> horaS = logicaNegocio.obtCboHoraReagenda("ltasis", fec_ultact.ToString("yyyy-MM-dd"), refer, "00:00", ef_cve, plazo, fec_ultact.ToString("yyyy-MM-dd"), idCita);
        ...
        {
            DateTime fechaEnt = Convert.ToDateTime(txtFecCita.Text),
