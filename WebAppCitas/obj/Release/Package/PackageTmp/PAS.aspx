<%@ Page Title="" Language="C#" MasterPageFile="~/Citas.Master" AutoEventWireup="true" CodeBehind="PAS.aspx.cs" Inherits="WebAppCitas.PAS" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="page-header text-center">
        <h1>PERMISO DE ACCESO A SALAS (PAS)</h1>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <div class="input-group">
                    ...
                    <asp:TextBox ID="txtVisita" runat="server" required="true" CssClass="form-control" OnSelectedIndexChanged="ddSala_SelectedIndexChanged" TabIndex="5" MaxLength="100">
                    </asp:TextBox>
                </div>
            </div>
            <div class="col-xs-3">
            ...
            <div class="col-xs-4">
                <div class="input-group">
                    ...
                    <asp:TextBox ID="txtEmpresa" runat="server" CssClass="form-control" required="true" OnSelectedIndexChanged="ddHoraE_SelectedIndexChanged" TabIndex="6"  MaxLength="100"></asp:TextBox>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-8">
                <div class="form-group">
                    ...
                    <asp:TextBox runat="server" CssClass="form-control" ID="txtDesc" TextMode="multiline" Rows="3" required="true" TabIndex="7"></asp:TextBox>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <div class="input-group">
                    ...
                    <asp:TextBox ID="txtPersona" runat="server" CssClass="form-control" TabIndex="8" MaxLength="100"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="col-xs-4">
                <div class="input-group">
                    ...
                    <asp:TextBox ID="txtIfe" runat="server" CssClass="form-control" TabIndex="9" MaxLength="100"></asp:TextBox>
                </div>
            </div>

            <div class="col-xs-1">
                <div class="input-group">
                    <asp:ImageButton ID="imbtAgregar" runat="server" ImageUrl="~/Media/Add.png" Style="width: 30px; height: 30px;" OnClick="imbtAgregar_Click" TabIndex="10" />
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-8">
                <ul class="list-inline">
                    <li><asp:Button ID="btnGuardarDato" runat="server" Text="Guardar Datos" CssClass="btn btn-default col-xs-offset-5" OnClick="btnGuardarDatos" /></li>
                    <li>.</li>
